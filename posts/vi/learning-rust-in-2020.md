...
Nếu bạn là một người mới hoàn toàn với Rust và muốn học nhiều nhất có thể chỉ trong một ngày thì nên đọc fasterthanlime's excellent [A half-hour to learn Rust](https://fasterthanli.me/blog/2020/a-half-hour-to-learn-rust/) and then checkout the awesome [Rustlings](https://github.com/rust-lang/rustlings) repo và hoàn thành các bài tập.
